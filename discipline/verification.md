...
When the user catches a discipline failure (presenting a guess as fact, expanding scope, etc.), append a Mistake block to the relevant package's `.nice/bump.md` per `../edit/session-log.md`. Do not minimize, do not deflect.
