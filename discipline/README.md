...
| `offboarding.md` | Before finishing a unit of work, reconcile every new discrepancy your change opened between the manifest and the package. The per-change, self-reviewed subset of the manifest audit. |
